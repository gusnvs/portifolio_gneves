  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="flex w-full max-w-[256px] items-center justify-between">
        ...
        <span className="text-[#7a2c05]">Pontos {score}</span>
      </div>
      <div
        tabIndex={0}
        onKeyDown={onKey}
      ...
      >
        ...
        {status !== "running" && (
          <div className="absolute inset-0 grid place-items-center bg-black/70 p-2 text-center text-white">
            {status === "over" ? (
              <GameOver game="snake" points={score} onRestart={start} />
            ) : (
              <div>
